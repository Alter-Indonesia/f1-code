...
/**
 * The palette F1 Code wears with no theme installed, captured from the app's
...
/**
 * The standard F1 Code look as a theme palette, for seeding a new theme when
...
/**
 * The status colors F1 Code shows without a theme, read from the app's own
