...
/**
 * The palette LifeOS wears with no theme installed, captured from the app's
...
/**
 * The standard LifeOS look as a theme palette, for seeding a new theme when
...
/**
 * The status colors LifeOS shows without a theme, read from the app's own
