...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.documentationList]: AuthOrchestrationReadScope,
  [WS_METHODS.documentationRead]: AuthOrchestrationReadScope,
  [WS_METHODS.documentationWrite]: AuthOrchestrationOperateScope,
  [WS_METHODS.documentationUpload]: AuthOrchestrationOperateScope,
  [WS_METHODS.documentationDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.cicdConnectionsList]: AuthOrchestrationReadScope,
  [WS_METHODS.cicdConnectionsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.cicdConnectionsDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.cicdProjectConnectionGet]: AuthOrchestrationReadScope,
  [WS_METHODS.cicdProjectConnectionSet]: AuthOrchestrationOperateScope,
